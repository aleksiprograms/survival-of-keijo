...
public class EnemyDropObject extends EnemyGuideObject {
    ...
    public boolean approachableFromRight;

    public void init(float x, float y, float z, int bigArea, Array<Integer> toBigAreas, Array<Integer> toSmallAreas, boolean approachableFromRight) {
