...
public class Constants {
    ...
    public static final int WEAPON_BAR_WIDTH   = WEAPON_TITLE_WIDTH + WEAPON_VALUE_WIDTH + WEAPON_UNIT_WIDTH;
    ...
    public static final int WEAPON_BAR_WIDTH_UPGRADE     = WEAPON_TITLE_WIDTH_UPGRADE + WEAPON_VALUE_WIDTH_UPGRADE + WEAPON_UNIT_WIDTH_UPGRADE + WEAPON_UPGRADE_WIDTH_UPGRADE + WEAPON_UNIT_WIDTH_UPGRADE;
    public static final int WEAPON_TABLE_WIDTH_UPGRADE   = 5 * GAP + SCROLL_PANE_THICKNESS + WEAPON_BAR_WIDTH_UPGRADE;
