...
public class Constants {
    ...
    public static final int UI_WEAPONS_IN_FULL_ROW = NUMBER_OF_WEAPONS - (NUMBER_OF_WEAPONS % UI_WEAPONS_IN_ROW);

    public static final int GAP                         = (int)(Gdx.graphics.getPpcY() * 0.15f);
    public static final int IMAGE_BUTTON_SIZE_HUGE      = (int)(Gdx.graphics.getPpcY() * 1.5f);
    public static final int IMAGE_BUTTON_SIZE_BIG       = (int)(Gdx.graphics.getPpcY() * 1.4f);
    public static final int IMAGE_BUTTON_SIZE_MEDIUM    = (int)(Gdx.graphics.getPpcY() * 1.0f);
    public static final int IMAGE_BUTTON_SIZE_SMALL     = (int)(Gdx.graphics.getPpcY() * 0.8f);
    public static final int IMAGE_BUTTON_SIZE_TINY      = (int)(Gdx.graphics.getPpcY() * 0.6f);
    public static final int TEXT_BUTTON_WIDTH           = 2 * IMAGE_BUTTON_SIZE_SMALL + 3 * GAP;
    public static final int TEXT_BUTTON_HEIGHT          = (int)(Gdx.graphics.getPpcY() * 0.8f);
    public static final int TEXT_SIZE_HUGE              = (int)(Gdx.graphics.getPpcY() * 0.5f);
    public static final int TEXT_SIZE_BIG               = (int)(Gdx.graphics.getPpcY() * 0.4f);
    public static final int TEXT_SIZE_MEDIUM            = (int)(Gdx.graphics.getPpcY() * 0.35f);
    public static final int TEXT_SIZE_SMALL             = (int)(Gdx.graphics.getPpcY() * 0.3f);
    public static final int TEXT_SIZE_TINY              = (int)(Gdx.graphics.getPpcY() * 0.24f);
    public static final int TEXT_BUTTON_TEXT_SIZE       = (int)(Gdx.graphics.getPpcY() * 0.32f);
    public static final int BOUGHT_ICON_SIZE            = (int)(Gdx.graphics.getPpcY() * 0.24f);
    public static final int SCROLL_PANE_SQUARE_SIZE     = (int)(Gdx.graphics.getPpcY() * 0.5f);
    public static final int SCROLL_PANE_OVER_SCROLL     = (int)(Gdx.graphics.getPpcY() * 1.0f);
    public static final int SCROLL_PANE_SCROLL_SIZE     = (int)(Gdx.graphics.getPpcY() * 0.3f);
    ...
    public static final int PROGRESS_BAR_WIDTH_LOADING  = (int)(Gdx.graphics.getWidth() / 2f);
    public static final int PROGRESS_BAR_WIDTH_HEALTH   = (int)(Gdx.graphics.getPpcY() * 3.5f);
    public static final int PROGRESS_BAR_MIN_WIDTH      = (int)(Gdx.graphics.getPpcY() * 0.3f);
    public static final int PROGRESS_BAR_HEIGHT         = (int)(Gdx.graphics.getPpcY() * 0.3f);
    public static final int PROGRESS_BAR_DATA_HEIGHT    = (int)(Gdx.graphics.getPpcY() * 0.13f);
    public static final int TEXT_RIGHT_GAP              = (int)(Gdx.graphics.getPpcY() * 0.15f);
    public static final int TEXT_BOTTOM_GAP             = (int)(Gdx.graphics.getPpcY() * 0.075f);
    public static final int SETTINGS_CELL_BOTTOM_GAP    = (int)(Gdx.graphics.getPpcY() * 0.15f);

    public static final int WEAPON_TITLE_WIDTH       = (int) (Gdx.graphics.getPpcY() * 2.3f);
    public static final int WEAPON_VALUE_WIDTH       = (int) (Gdx.graphics.getPpcY() * 1.0f);
    public static final int WEAPON_UNIT_WIDTH        = (int) (Gdx.graphics.getPpcY() * 0.8f);
    public static final int WEAPON_LEVEL_WIDTH       = (int) (Gdx.graphics.getPpcY() * 1.5f);
    ...
    public static final int WEAPON_BASIC_INFO_TITLE_TABLE_WIDTH = (int) (Gdx.graphics.getPpcY() * 2.3f);
    public static final int WEAPON_BASIC_INFO_DATA_TABLE_WIDTH  = WEAPON_BAR_WIDTH_VALUE - WEAPON_BASIC_INFO_TITLE_TABLE_WIDTH;

    public static final int WEAPON_TITLE_WIDTH_UPGRADE   = (int) (Gdx.graphics.getPpcY() * 2.2f);
    public static final int WEAPON_VALUE_WIDTH_UPGRADE   = (int) (Gdx.graphics.getPpcY() * 0.8f);
    public static final int WEAPON_UNIT_WIDTH_UPGRADE    = (int) (Gdx.graphics.getPpcY() * 0.7f);
    public static final int WEAPON_LEVEL_WIDTH_UPGRADE   = (int) (Gdx.graphics.getPpcY() * 1.1f);
    public static final int WEAPON_UPGRADE_WIDTH_UPGRADE = (int) (Gdx.graphics.getPpcY() * 0.8f);
    public static final int WEAPON_PRICE_WIDTH_UPGRADE   = (int) (Gdx.graphics.getPpcY() * 1.0f);
    ...
    public static final int DIALOG_BOX_HEIGHT_WEAPON = (int)(Gdx.graphics.getPpcY() * 5f);
